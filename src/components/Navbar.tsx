...
const Navbar = () => {
    ...
    return (
        <nav ref={nav} className="bg-white w-full fixed h-20 px-6 md:px-16">
            ...
            <div  className={`transition-all ease-in-out duration-500 absolute flex flex-col space-y-4 font-semibold p-4 right-0 top-20 border w-60 ${mobileMenuOpen? 'translate-x-0' : 'translate-x-full'}`}>
                <Link to="#about">About Us</Link>
                <Link to="#contact">Contact Us</Link>
                <Link to="#faq">FAQ</Link>
                <Link to="/login">
